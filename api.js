...
const bcrypt = require('bcrypt');             //Include bcrypt variables for strong passsword
...
app.post('/auth', async(req, res)=>{
  ...
  if(username && password){
    connectionDB.query('SELECT * FROM students WHERE Username = ?', [username], async (error, results, fields)=>{
